...
static size_t mem_anda_size_check (const size_t* sizes, size_t dims, size_t elem_size, const char* file, unsigned int line) {
	if (elem_size == 0) {
...
void* memtrack_alloc_nd_array_without_lock (const size_t* sizes, size_t dims, size_t elem_size, const char* file, unsigned int line) {
...
void* memtrack_alloc_nd_array (const size_t* sizes, size_t dims, size_t elem_size, const char* file, unsigned int line) {
	memtrack_lock();
...
void* memtrack_calloc_nd_array_without_lock (const size_t* sizes, size_t dims, size_t elem_size, const char* file, unsigned int line) {
	size_t a_size = mem_anda_size_check(sizes, dims, elem_size, file, line);
	if (a_size == 0) return NULL;
...
void* memtrack_calloc_nd_array (const size_t* sizes, size_t dims, size_t elem_size, const char* file, unsigned int line) {
	memtrack_lock();
...
void memtrack_free_nd_array (void* array, const char* file, unsigned int line) {
