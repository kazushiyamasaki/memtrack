...
void* memtrack_aligned_alloc_without_lock (size_t alignment, size_t size, const char* file, unsigned int line) {
...
void* memtrack_aligned_alloc (size_t alignment, size_t size, const char* file, unsigned int line) {
	memtrack_lock();
...
void* memtrack_aligned_calloc_without_lock (size_t alignment, size_t count, size_t size, const char* file, unsigned int line) {
	if (size == 0) {
...
void* memtrack_aligned_calloc (size_t alignment, size_t count, size_t size, const char* file, unsigned int line) {
	memtrack_lock();
...
void* memtrack_aligned_realloc_without_lock (void* ptr, size_t alignment, size_t size, const char* file, unsigned int line) {
	if (ptr == NULL)
...
void* memtrack_aligned_realloc (void* ptr, size_t alignment, size_t size, const char* file, unsigned int line) {
	memtrack_lock();
...
void* memtrack_aligned_recalloc_without_lock (void* ptr, size_t alignment, size_t count, size_t size, const char* file, unsigned int line) {
	if (ptr == NULL)
...
void* memtrack_aligned_recalloc (void* ptr, size_t alignment, size_t count, size_t size, const char* file, unsigned int line) {
	memtrack_lock();
...
void* memtrack_aligned_alloc_array_without_lock (size_t alignment, size_t count, size_t size, const char* file, unsigned int line) {
	if (size == 0) {
		fprintf(stderr, "No processing was done because the size is zero.\nFile: %s   Line: %u\n", file, line);
		return NULL;
	} else if (count > (SIZE_MAX / size)) {
...
void* memtrack_aligned_alloc_array (size_t alignment, size_t count, size_t size, const char* file, unsigned int line) {
	memtrack_lock();
...
void* memtrack_aligned_calloc_array (size_t alignment, size_t count, size_t size, const char* file, unsigned int line) {
	return memtrack_aligned_calloc(alignment, count, size, file, line);
}


void* memtrack_aligned_realloc_array_without_lock (void* ptr, size_t alignment, size_t count, size_t size, const char* file, unsigned int line) {
	if (size == 0) {
		memtrack_free_without_lock(ptr, file, line);
		return NULL;
	} else if (count > (SIZE_MAX / size)) {
...
void* memtrack_aligned_realloc_array (void* ptr, size_t alignment, size_t count, size_t size, const char* file, unsigned int line) {
	memtrack_lock();
	void* new_ptr = memtrack_aligned_realloc_array_without_lock(ptr, alignment, count, size, file, line);
	memtrack_unlock();
	return new_ptr;
...
void* memtrack_aligned_recalloc_array (void* ptr, size_t alignment, size_t count, size_t size, const char* file, unsigned int line) {
