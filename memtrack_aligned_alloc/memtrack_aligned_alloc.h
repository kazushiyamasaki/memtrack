 ...
 */
extern void* memtrack_aligned_alloc (size_t alignment, size_t size, const char* file, unsigned int line);
 ...
 */
extern void* memtrack_aligned_calloc (size_t alignment, size_t count, size_t size, const char* file, unsigned int line);
 ...
 */
extern void* memtrack_aligned_realloc (void* ptr, size_t alignment, size_t size, const char* file, unsigned int line);
 ...
 */
extern void* memtrack_aligned_recalloc (void* ptr, size_t alignment, size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @note: displays a message and returns NULL if count * size is not a multiple of alignment
 */
extern void* memtrack_aligned_alloc_array (size_t alignment, size_t count, size_t size, const char* file, unsigned int line);
 ...
 */
extern void* memtrack_aligned_calloc_array (size_t alignment, size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @note: displays a message and returns NULL if count * size is not a multiple of alignment
 */
extern void* memtrack_aligned_realloc_array (void* ptr, size_t alignment, size_t count, size_t size, const char* file, unsigned int line);
 ...
 */
extern void* memtrack_aligned_recalloc_array (void* ptr, size_t alignment, size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @return: pointer to allocated memory block, or NULL on failure
 */
extern void* memtrack_aligned_alloc_without_lock (size_t alignment, size_t size, const char* file, unsigned int line);
 ...
 * @note: displays a message and returns NULL if count * size is not a multiple of alignment
 */
extern void* memtrack_aligned_calloc_without_lock (size_t alignment, size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @return: pointer to reallocated memory block, or NULL on failure
 */
extern void* memtrack_aligned_realloc_without_lock (void* ptr, size_t alignment, size_t size, const char* file, unsigned int line);
 ...
 * @note: newly allocated memory beyond the original size is zero-initialized, displays a message and returns NULL if count * size is not a multiple of alignment
 */
extern void* memtrack_aligned_recalloc_without_lock (void* ptr, size_t alignment, size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @note: displays a message and returns NULL if count * size is not a multiple of alignment
 */
extern void* memtrack_aligned_alloc_array_without_lock (size_t alignment, size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @note: displays a message and returns NULL if count * size is not a multiple of alignment
 */
extern void* memtrack_aligned_realloc_array_without_lock (void* ptr, size_t alignment, size_t count, size_t size, const char* file, unsigned int line);
