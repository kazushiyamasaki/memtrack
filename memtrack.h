 ...
 */
extern void* memtrack_malloc (size_t size, const char* file, unsigned int line);
 ...
 * @return: pointer to allocated memory block, or NULL on failure
 */
extern void* memtrack_calloc (size_t count, size_t size, const char* file, unsigned int line);
 ...
 */
extern void* memtrack_realloc (void* ptr, size_t size, const char* file, unsigned int line);
 ...
 * @param line: line number of the caller, usually specified with __LINE__
 */
extern void memtrack_free (void* ptr, const char* file, unsigned int line);
 ...
 */
extern void* memtrack_recalloc (void* ptr, size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @return: pointer to allocated memory block, or NULL on failure
 */
extern void* memtrack_malloc_array (size_t count, size_t size, const char* file, unsigned int line);
 ...
 */
extern void* memtrack_calloc_array (size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @return: pointer to reallocated memory block, or NULL on failure
 */
extern void* memtrack_realloc_array (void* ptr, size_t count, size_t size, const char* file, unsigned int line);
 ...
 */
extern void* memtrack_recalloc_array (void* ptr, size_t count, size_t size, const char* file, unsigned int line);
 ...
 */
extern size_t memtrack_get_size (void* ptr, const char* file, unsigned int line);
 ...
 */
extern void memtrack_entry_add (void* ptr, size_t size, const char* file, unsigned int line);
 ...
 * @param line: line number of the point where the wrapper function calling this function is invoked
 */
extern void memtrack_entry_update (void* old_ptr, void* new_ptr, size_t new_size, const char* file, unsigned int line);
 ...
 * @param line: line number of the point where the wrapper function calling this function is invoked
 */
extern void memtrack_entry_free (void* ptr, const char* file, unsigned int line);
 ...
 * @return: pointer to allocated memory block, or NULL on failure
 */
extern void* memtrack_malloc_without_lock (size_t size, const char* file, unsigned int line);
 ...
 * @return: pointer to allocated memory block, or NULL on failure
 */
extern void* memtrack_calloc_without_lock (size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @return: pointer to reallocated memory block, or NULL on failure
 */
extern void* memtrack_realloc_without_lock (void* ptr, size_t size, const char* file, unsigned int line);
 ...
 * @param line: line number of the caller, usually specified with __LINE__
 */
extern void memtrack_free_without_lock (void* ptr, const char* file, unsigned int line);
 ...
 * @note: newly allocated memory beyond the original size is zero-initialized
 */
extern void* memtrack_recalloc_without_lock (void* ptr, size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @return: pointer to allocated memory block, or NULL on failure
 */
extern void* memtrack_malloc_array_without_lock (size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @return: pointer to reallocated memory block, or NULL on failure
 */
extern void* memtrack_realloc_array_without_lock (void* ptr, size_t count, size_t size, const char* file, unsigned int line);
 ...
 * @return: size of the memory block in bytes, or 0 on failure
 */
extern size_t memtrack_get_size_without_lock (void* ptr, const char* file, unsigned int line);
